...
def intro(option):
    ...
    print_pause("So Rafa downloaded Tinder")
    ...
    print_pause("So should he go meet Scarlet or Emily")


def emily(option):
    print_pause("\nYou guys have decided to meet for dinner at an Asian restaurant at 2pm")
    print_pause("You want to impress her, so you dress nice")
    print_pause("\nYou arrived 5 minutes late and you see her sitting")
    print_pause("In your brain, you are like damn! She is beautiful.")
    print_pause("\nHe goes to her and they hug and stuff")
    print_pause("\nHe goes to her and they hug and stuff")
    print_pause("They end up talking for hours and seem to be enjoying.")
    date(option)


def scarlet_catfish():
    print_pause("\nHe goes to the mall to meet Scarlet")
    print_pause("He arrived early, so he went to find a place to sit down")
    print_pause("\nThe girl texts him and says she is 5 minutes away")
    print_pause("So he waits")
    print_pause("\n10 minutes later, someone touched him on the shoulder from behind")
    print_pause("and it turned out to be a fat guy")
